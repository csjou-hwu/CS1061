// Ref: https://msdn.microsoft.com/zh-tw/library/system.random(v=vs.110).aspx#UniqueArray
using System;
public class Card
{
    public Suit Suit;
...
public class Example
{
    ...
    private static void ShowCards(Card[] cards)
    {
        foreach (var card in cards)
            if (card != null)
                Console.WriteLine("{1} {0}", card.FaceValue, card.Suit);
    }
}
